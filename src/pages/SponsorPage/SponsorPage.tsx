  ...
  return (
    <div className="bg-[#232227] rounded-[clamp(12px,1.5vw,20px)] py-[clamp(12px,1.5vw,24px)] px-[clamp(10px,1.3vw,20px)] flex flex-col gap-[clamp(12px,1.5vw,24px)]">
      <div className="w-full rounded-[12px] overflow-hidden">
        <img
          src={postImg}
          alt={t.post.postImageAlt}
          className="w-full h-auto object-contain"
        />
      </div>

      <div className="flex flex-col gap-3">
        <p className="font-inter text-[clamp(13px,1.4vw,16px)] text-white leading-[120%]">
          {t.post.title}
        </p>
        <p className="font-inter text-[clamp(13px,1.4vw,16px)] text-white leading-[120%]">
          {t.post.description}
        ...
        <div className="flex flex-col gap-1">
          ...
          <ul className="list-disc pl-5 font-inter text-[clamp(13px,1.4vw,16px)] text-white leading-[120%]">
            {t.post.whyItems.map((item, i) => <li key={i}>{item}</li>)}
          </ul>
        </div>
      </div>
